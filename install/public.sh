...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/2duat/Panel/main/install/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/2duat/Panel/main/install/update6.sh|bash
	fi
